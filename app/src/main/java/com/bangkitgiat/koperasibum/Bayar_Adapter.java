...
public class Bayar_Adapter extends RecyclerView.Adapter<Bayar_Adapter.MyViewHolder> implements Filterable {
    ...
    public Bayar_Adapter(Context mContext, List<CartUtil> mData) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view = mInflater.inflate(R.layout.bayar_row,parent,false);
